...
pub mod db_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_user(
            &mut self,
            request: impl tonic::IntoRequest<super::GetUserMessage>,
        ) -> std::result::Result<
            tonic::Response<super::super::models::User>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/db.Db/GetUser");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("db.Db", "GetUser"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod db_server {
    ...
    #[async_trait]
    pub trait Db: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_user(
            &self,
            request: tonic::Request<super::GetUserMessage>,
        ) -> std::result::Result<
            tonic::Response<super::super::models::User>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/db.Db/GetUser" => {
                    #[allow(non_camel_case_types)]
                    struct GetUserSvc<T: Db>(pub Arc<T>);
                    impl<T: Db> tonic::server::UnaryService<super::GetUserMessage>
                    for GetUserSvc<T> {
                        type Response = super::super::models::User;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Db>::get_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "db.Db";
    impl<T> tonic::server::NamedService for DbServer<T> {
